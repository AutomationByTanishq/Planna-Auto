...
public class Brokenlinks {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.findElement(By.xpath("//input[@id='pas']")).sendKeys("123123");

		driver.findElement(By.xpath("//input[@value='login']")).click();

		System.out.println("Step :: Click on Auction Overview Page");

		driver.findElement(By.xpath("//a[@title='Auctions']")).click();

		driver.findElement(By.xpath("//table//tr//td[@id='alf4_row0_0']//..//a[@title='Edit info']")).click();

		driver.findElement(By.xpath("//div[@id='content']//a[text()='Reports']")).click();
