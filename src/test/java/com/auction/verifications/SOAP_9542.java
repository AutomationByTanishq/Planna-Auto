...
public class SOAP_9542 {
	...
	public static void Verify_to_create_and_update_Auction_with_Integer_and_Decimal_custom_fields_having_text_data_via_SOAP() 
		...
		String str_username = Common.generateRandomChars(6);

		final String POST_USER = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:soap=\"http://qa3-6-auto.auctionserver.net/api/soap12\">\r\n"
				+ "  <soapenv:Header>\r\n" + " <soap:Authenticate>\r\n" + "<Login>admin</Login>\r\n" 
				+ "<Password>123123</Password>\r\n" + "</soap:Authenticate>\r\n" + "<soap:SetNamespace>\r\n"
				+ "<Namespace>SAM user.id</Namespace>\r\n" + "</soap:SetNamespace>\r\n" + "</soapenv:Header>\r\n"
				+ " <soapenv:Body>\r\n" + " <soap:CreateUser>\r\n" + " <Username>" + str_username + "</Username>\r\n" 
				+ " <Data>\r\n" + " <CustomFieldInteger>dsfs</CustomFieldInteger>\r\n"
				+ " <CustomFieldDecimal>fdd</CustomFieldDecimal>\r\n"
				+ " </Data>\r\n" + "  </soap:CreateUser>\r\n" + " </soapenv:Body>\r\n" + "</soapenv:Envelope>\r\n";
		...
		if (responseCode == 200) { // success
			...
			System.out.println("Generated UserId :" + str);
		} else {
		...
		/***************** CREATE_USER ***************/
		System.out.println("***********************CreateUser***********************");
		String str_username1 = Common.generateRandomChars(6);

		final String POST_USER1 = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:soap=\"http://qa3-6-auto.auctionserver.net/api/soap12\">\r\n"
				+ "  <soapenv:Header>\r\n" + " <soap:Authenticate>\r\n" + "<Login>admin</Login>\r\n" 
				+ "<Password>123123</Password>\r\n" + "</soap:Authenticate>\r\n" + "<soap:SetNamespace>\r\n"
				+ "<Namespace>SAM user.id</Namespace>\r\n" + "</soap:SetNamespace>\r\n" + "</soapenv:Header>\r\n"
				+ " <soapenv:Body>\r\n" + " <soap:CreateUser>\r\n" + " <Username>" + str_username1 + "</Username>\r\n" 
				+ " <Data>\r\n" + " <CustomFieldInteger>2</CustomFieldInteger>\r\n"
				+ " <CustomFieldDecimal>2</CustomFieldDecimal>\r\n"
				+ " </Data>\r\n" + "  </soap:CreateUser>\r\n" + " </soapenv:Body>\r\n" + "</soapenv:Envelope>\r\n";

		System.out.println(POST_USER1);
		...
		if (responseCode1 == 200) { // success
			...
			// print result
			System.out.println("Response Body :" + response.toString());
			str1 = response.substring(421, 424);

			System.out.println("Generated UserId :" + str1);
		} else {
			System.out.println("POST NOT WORKED");
		}
		...
		final String POST_UPDATEUSER = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:soap=\"http://qa3-6-auto.auctionserver.net/api/soap12\">\r\n"
				+ "  <soapenv:Header>\r\n" + " <soap:Authenticate>\r\n" + "<Login>admin</Login>\r\n" 
				+ "<Password>123123</Password>\r\n" + "</soap:Authenticate>\r\n" + "<soap:SetNamespace>\r\n"
				+ "<Namespace>SAM user.id</Namespace>\r\n" + "</soap:SetNamespace>\r\n" + "</soapenv:Header>\r\n"
				+ " <soapenv:Body>\r\n" + " <soap:UpdateUser>\r\n" + "  <Id>" + str1 + "</Id>\r\n" 
				+ " <Data>\r\n" + " <CustomFieldInteger>fsf</CustomFieldInteger>\r\n"
				+ " <CustomFieldDecimal>fdgd</CustomFieldDecimal>\r\n"
				+ " </Data>\r\n" + "  </soap:UpdateUser>\r\n" + " </soapenv:Body>\r\n" + "</soapenv:Envelope>\r\n";
		
		
		System.out.println(POST_UPDATEUSER);
		...
		os2.write(POST_UPDATEUSER.getBytes());
		os2.flush();
		os2.close();
		...
		if (responseCode2 == 200) { // success
	        ...
	        System.out.println("Updated User" +str21);
		} else {
