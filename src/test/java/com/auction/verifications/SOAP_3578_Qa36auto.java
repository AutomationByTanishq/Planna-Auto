...
public class SOAP_3578_Qa36auto {
	static ConfigFileReader configFileReader= new ConfigFileReader();

	@Test
	public static void Verify_Create_and_Update_Item_and_Lot_with_Allowbuyerselectquantity_Access_via_SOAP_request_on_Qa36auto() throws IOException {
		...
		if (responseCode == 200) { // success
			...
			str = response.substring(359, 364);
...
//        System.out.println("generated id :" +str);
	...
	if (responseCode2 == 200) { // success
		...
		// print result
		System.out.println("Response Body :" + response.toString());
		str1 = response.substring(356, 360);

		System.out.println("Generated Auction ID :" + str1);
	} else {
		System.out.println("POST NOT WORKED");
	}
	...
	if (responseCode3 == 200) { // success
		...
		System.out.println("Response Body :" + response.toString());
        strnew = response.substring(365, 370);
