...
public class LiveSaleAuction extends AbstractPage {

	public LiveSaleAuction(WebDriver driver) {
		super(driver);
	...
	public void CreatenewAuction() throws InterruptedException, ParseException {
		...
		common.type("//input[@id='" + LEGACY_ADMIN_TXT_START_CLOSING_DATE + "']", tomorrowDate);

		common.type("//input[@id='" + LEGACY_ADMIN_TXT_NUMBER_OF_DAYS + "']", "1");

		common.type("//input[@id='" + LEGACY_ADMIN_TXT_SALE_NUMBER + "']", "123");

		String name = common.generateRandomChars(7);
		common.type("//input[@id='" + LEGACY_ADMIN_TXT_SALE + "']", name);
	...
	public String AllFieldsFill(String date) throws InterruptedException, ParseException {
		...
		common.type("//input[@id='" + LEGACY_ADMIN_TXT_START_CLOSING_DATE + "']", date);

		common.type("//input[@id='" + LEGACY_ADMIN_TXT_NUMBER_OF_DAYS + "']", "1");

		common.type("//input[@id='" + LEGACY_ADMIN_TXT_SALE_NUMBER + "']", "123123555");
